...
#
#  $ bin/test -s rer.solrpush -t test_example.robot --all
#
# Run this robot test with robot server (which is faster):
#
# 1) Start robot server:
#
# $ bin/robot-server --reload-path src rer.solrpush.testing.RER_SOLRPUSH_ACCEPTANCE_TESTING
#
# 2) Run robot tests:
#
# $ bin/robot src/rer/solrpush/tests/robot/test_example.robot
#
